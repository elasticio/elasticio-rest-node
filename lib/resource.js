...
ApiResource.method = function method(spec) {
    ...
    //self.client._api.basePath=self.client._api.basePath+'/'+spec.apiVersion||self.client._api.client.API_VERSION;
    ...
    function sendRequest() {
        ...
        return Q()
            .then(provideOptions)
            .then((res)=>{console.log("before request...", res); return res;})
            .then(sendRequest)
          //  .then((res)=>{console.log("after request...", res); return res;})
